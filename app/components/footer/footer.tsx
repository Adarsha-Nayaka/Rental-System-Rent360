        ...
        <div className="grid-1 grid gap-8 md:grid-cols-2 lg:grid-cols-4">
          ...
          <div className="">
            ...
            <p className="mb-4">
              ...
              href='http://localhost:3000/?category=Party%20and%20Events'
              >Party & Events</a>
            </p>
            <p className="mb-4">
              <a className="text-white-600 dark:text-white-200"
              href='http://localhost:3000/?category=Gaming'
              >Gaming</a>
            </p>
            <p className="mb-4">
              <a className="text-white-600 dark:text-white-200"
              href='http://localhost:3000/?category=Photography'
              >Photography</a>
            </p>
            <p>
              <a className="text-white-600 dark:text-white-200"
              href='http://localhost:3000/?category=Music'
              >Music</a>
            </p>
          ...
          <div className="">
            ...
            <p className="mb-4">
              <a className="text-white-600 dark:text-white-200"
              href='http://localhost:3000/?category=Kitchen'
              >Kithcen</a>
            </p>
            <p className="mb-4">
              <a className="text-white-600 dark:text-white-200"
              href='http://localhost:3000/?category=Books'
              >Books</a>
            </p>
            <p className="mb-4">
              <a className="text-white-600 dark:text-white-200"
              href='http://localhost:3000/?category=Transport'
              >Transport</a>
            </p>
            <p>
              <a className="text-white-600 dark:text-white-200"
              href='http://localhost:3000/?category=Fitness'
              >Fitness</a>
            </p>
          </div>
          {/* <!-- Contact section --> */}
